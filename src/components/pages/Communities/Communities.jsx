  ...
  return (
    <>
      <SEO
        ...
        description="Connect with groups of people who share your interests on ECHO."
      />
      <StructuredData />
      <div
        style={{
      ...
      >
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '16px', maxWidth: '320px', lineHeight: '1.6' }}>
