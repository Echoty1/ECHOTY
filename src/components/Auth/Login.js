  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isSignup) {
        ...
        // additional user data will be created in AuthContext
      } else {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ fontSize: '32px', fontWeight: 900, background: 'linear-gradient(135deg, #6C3CE1, #EC4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>ECHO</div>
          <p style={{ color: '#888', fontSize: '14px', marginTop: '4px' }}>Premium Social Community</p>
        </div>
